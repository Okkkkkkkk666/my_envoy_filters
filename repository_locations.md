...
REPOSITORY_LOCATIONS_SPEC = dict(
    ...
    com_github_envoyproxy_sqlparser = dict(
        ...
        project_url = "https://git.sr.ok/cpp-deps/sql-parser",
        version = "ccd3f68b50bb2b96ce69afa7b956b3bd826643cc",
        sha256 = "5a2015d54f266b4988f7d6a75c2679fbcc28b7ad7d2b8532773dcd51f1cc3d1d",
        strip_prefix = "sql-parser",
        urls = ["https://git.sr.ok/cpp-deps/sql-parser/archive/{version}.tar.gz"],
...
com_googlesource_googleurl = dict(
        ...
        project_url = "https://git.sr.ok/cpp-deps/googleurl",
        ...
        sha256 = "c2866211b30b9466aaa31649e566d627e8f59dc0fc8688a6784d66403b522c7e",
        urls = ["file:///home/hubin/workspace/official_googleurl.tar.gz"],
        use_category = ["controlplane", "dataplane_core"],
        extensions = [],
    ...
    com_github_libicmp = dict(
        project_name = "libicmp",
        project_desc = "{libicmp} is an open-source icmp library providing icmp",
        project_url = "https://github.com/troglobit/libicmp.git",
        version = "master",
        sha256 = "14f459b41054716be90c3424c2dc2607fa1990667221e6a4aca2602cfa102f55",
        strip_prefix = "libicmp-{version}",
        urls = ["http://file.sr.ok/CICD/cpp/envoy_filters/libicmp-master.zip"],
        use_category = ["dataplane_core"],
        release_date = "2022-07-03",
        cpe = "N/A",
    ),
    cn_ouryun_libnsq = dict(
        project_name = "libnsq",
        project_desc = "{libnsq} is an open-source nsq client library",
        project_url = "https://git.ouryun.cn/base/libnsq.git",
        version = "libnsq_tls",
        sha256 = "b3c1a5d7bf3f92e378efabc282447885fa0c379c629387a6b90fa52219e110be",
        strip_prefix = "libnsq",
        urls = ["https://git.ouryun.cn/base/libnsq/archive/{version}.zip"],
        use_category = ["other"],
        release_date = "2022-07-03",
        cpe = "N/A",
    ),

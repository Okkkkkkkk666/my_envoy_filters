...
uncomment.sh "$1" --comment -h \
  ...
  --uncomment-func-decl SSL_CTX_set_security_level \
  --uncomment-func-decl SSL_CTX_use_sign_certificate \
  --uncomment-func-decl SSL_CTX_use_sign_PrivateKey \
  --uncomment-func-decl SSL_CTX_use_enc_certificate \
  --uncomment-func-decl SSL_CTX_use_enc_PrivateKey \
  ...
  --uncomment-func-decl SSL_CTX_disable_ntls \
  --uncomment-func-decl SSL_CTX_enable_force_ntls \
  --uncomment-func-decl SSL_CTX_disable_force_ntls \
  --uncomment-func-decl SSL_enable_ntls \
  --uncomment-func-decl SSL_disable_ntls \
  --uncomment-func-decl SSL_enable_force_ntls \
  --uncomment-func-decl SSL_disable_force_ntls \
  --uncomment-func-decl SSL_CTX_enable_sm_tls13_strict \
  --uncomment-func-decl SSL_CTX_disable_sm_tls13_strict \
  --uncomment-func-decl SSL_enable_sm_tls13_strict \
  --uncomment-func-decl SSL_disable_sm_tls13_strict

...
public:
  ...
  static void addLengthEncodedString(Buffer::Instance& buffer, const std::string& str);
  ...
  static DecodeStatus readLengthEncodedString(Buffer::Instance& buffer, std::string& str);

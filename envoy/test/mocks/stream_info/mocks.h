...
public:
  ...
  MOCK_METHOD(void, setListenerStatPrefix, (const std::string&));
  MOCK_METHOD(const std::string&, listenerStatPrefix, (), (const));
  MOCK_METHOD(const Network::Address::InstanceConstSharedPtr&, predictUpstreamRemoteAddress, (),
              (const));
  MOCK_METHOD(void, setPredictUpstreamRemoteAddress,
              (const Network::Address::InstanceConstSharedPtr&));
  MOCK_METHOD(void, setIsLocalReply, (bool));
  MOCK_METHOD(bool, isLocalReply, (), (const));
  MOCK_METHOD(void, setOriginHost, (absl::string_view));
  MOCK_METHOD(const std::string&, originHost, (), (const));
  MOCK_METHOD(void, setIsVHostMatched, (bool));
  MOCK_METHOD(bool, isVHostMatched, (), (const));

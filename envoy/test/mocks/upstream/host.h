...
public:
  ...
  MOCK_METHOD(const std::string&, dnsAddr, (), (const));
...
public:
  ...
  MOCK_METHOD(MonotonicTime, creationTime, (), (const));
  MOCK_METHOD(const std::string&, dnsAddr, (), (const));
  MOCK_METHOD(void, healthFailReasonSet, (HealthFailReason reason));
  MOCK_METHOD(Host::HealthFailReason, healthFailReasonGet, (), (const));
  MOCK_METHOD(void, healthFailReasonClear, ());

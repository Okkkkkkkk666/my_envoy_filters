...
#include "source/common/srhino_plugin_framework/v1_3_x/libs/net/http_call_impl.h"
...
public:
  void SetUp(std::string& cluster_name, std::chrono::milliseconds timeout) {
    ...
    header_map_ = std::make_shared<SrhinoPluginFramework::v1_3_x::HeaderMapImpl>();
    data_map_ = std::make_shared<SrhinoPluginFramework::v1_3_x::DataSlicesImpl>();
...
public:
  ...
  std::shared_ptr<SrhinoPluginFramework::v1_3_x::HeaderMapImpl> header_map_;
  std::shared_ptr<SrhinoPluginFramework::v1_3_x::DataSlicesImpl> data_map_;

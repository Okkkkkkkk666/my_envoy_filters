...
public:
  ...
  virtual std::unique_ptr<Type::Matcher::IpSet> createIpSet(
      const srhino_plugin_framework::v1_0_x::proto::config::type::matcher::IpSet& ip_set) const = 0;

  virtual std::unique_ptr<Type::Matcher::UserMatcher> createUserMatcher(
      const srhino_plugin_framework::v1_0_x::proto::config::type::matcher::UserMatcher& user)
      const = 0;
};

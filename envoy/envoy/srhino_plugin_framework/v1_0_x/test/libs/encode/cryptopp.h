...
#include "envoy/srhino_plugin_framework/v1_0_x/libs/encode/cryptopp.h"
using testing::_;
...
namespace Libs {
namespace Encode {
class MockCryptopp : public SrhinoPluginFramework::v1_0_x::Libs::Encode::Cryptopp {
public:
  MockCryptopp()
      : mock_des_(std::make_shared<MockDes>()), mock_triple_des_(std::make_shared<MockTripleDes>()),
        ...
        mock_md5_(std::make_shared<MockMd5>()), mock_sha256_(std::make_shared<MockSha256>()),
        mock_sha512_(std::make_shared<MockSha512>()), mock_sha1_(std::make_shared<MockSha1>()),
        mock_sha3_(std::make_shared<MockSha3>()), mock_sm3_(std::make_shared<MockSm3>()) {

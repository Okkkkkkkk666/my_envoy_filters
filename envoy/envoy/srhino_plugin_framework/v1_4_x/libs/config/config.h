...
public:
  ...
  virtual std::unique_ptr<Type::Matcher::IpSet> createIpSet(
      const srhino_plugin_framework::v1_4_x::proto::config::type::matcher::IpSet& ip_set) const = 0;

  virtual std::unique_ptr<Type::Matcher::IPGroups> createIPGroups(
  ...
  virtual std::unique_ptr<Type::Matcher::DateMatcher> createDateMatcher(
      const srhino_plugin_framework::v1_4_x::proto::config::type::matcher::DateMatcher& date)
      const = 0;
};

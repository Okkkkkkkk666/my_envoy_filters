...
#include "envoy/srhino_plugin_framework/v1_4_x/test/connection_info.h"
#include "envoy/srhino_plugin_framework/v1_4_x/test/header_map.h"
#include "envoy/srhino_plugin_framework/v1_4_x/test/route_info.h"
#include "envoy/srhino_plugin_framework/v1_4_x/test/thread_info.h"
#include "envoy/srhino_plugin_framework/v1_4_x/test/virtual_host_info.h"
...
public:
  MockContext() {
    ON_CALL(*this, virtualHostInfo())
        .WillByDefault(
            testing::ReturnRef(dynamic_cast<const SrhinoPluginFramework::v1_4_x::VirtualHostInfo&>(
                virtual_host_info_)));

    ON_CALL(*this, routeInfo())
        .WillByDefault(testing::ReturnRef(
            dynamic_cast<const SrhinoPluginFramework::v1_4_x::RouteInfo&>(route_info_)));

    ON_CALL(*this, connectionInfo())
        .WillByDefault(testing::ReturnRef(
            dynamic_cast<const SrhinoPluginFramework::v1_4_x::ConnectionInfo&>(connection_info_)));

    ON_CALL(*this, threadInfo())
        .WillByDefault(testing::ReturnRef(
            dynamic_cast<SrhinoPluginFramework::v1_4_x::ThreadInfo&>(thread_info_)));
  }
...
public:
  testing::NiceMock<SrhinoPluginFramework::v1_4_x::Test::MockVirtualHostInfo> virtual_host_info_;
  testing::NiceMock<SrhinoPluginFramework::v1_4_x::Test::MockRouteInfo> route_info_;
  testing::NiceMock<SrhinoPluginFramework::v1_4_x::Test::MockConnectionInfo> connection_info_;
  testing::NiceMock<SrhinoPluginFramework::v1_4_x::Test::MockThreadInfo> thread_info_;
};

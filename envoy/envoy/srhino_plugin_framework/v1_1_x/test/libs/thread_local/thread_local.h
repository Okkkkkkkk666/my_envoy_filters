...
#include "envoy/srhino_plugin_framework/v1_1_x/libs/thread_local/thread_local.h"
#include "envoy/srhino_plugin_framework/v1_1_x/test/libs/thread_local/cluster.h"

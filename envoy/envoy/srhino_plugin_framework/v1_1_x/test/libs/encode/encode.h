...
#include "envoy/srhino_plugin_framework/v1_1_x/libs/encode/encode.h"
#include "envoy/srhino_plugin_framework/v1_1_x/test/libs/encode/compressor.h"
#include "envoy/srhino_plugin_framework/v1_1_x/test/libs/encode/cryptopp.h"
#include "envoy/srhino_plugin_framework/v1_1_x/test/libs/encode/decompressor.h"
#include "envoy/srhino_plugin_framework/v1_1_x/test/libs/encode/openssl.h"
...
namespace Libs {
namespace Encode {
using namespace SrhinoPluginFramework::v1_1_x::Libs::Encode;
using testing::_;
using testing::Return;

class MockEncode : public SrhinoPluginFramework::v1_1_x::Libs::Encode::Encode {
public:
  MockEncode() {

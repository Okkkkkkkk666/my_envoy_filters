...
public:
  MOCK_METHOD(std::unique_ptr<SrhinoPluginFramework::Libs::Config::Type::Matcher::Matcher>,
              createMatcher,
              (const srhino_plugin_framework::v1_1_x::proto::config::type::matcher::Matcher&),
              (const));
  MOCK_METHOD(std::unique_ptr<SrhinoPluginFramework::Libs::Config::Type::Matcher::Rule>, createRule,
              (const std::string&,
               const srhino_plugin_framework::v1_1_x::proto::config::core::CidrRange&, bool,
               const google::protobuf::RepeatedPtrField<
                   srhino_plugin_framework::v1_1_x::proto::config::type::matcher::Matcher>&),
              (const));
  MOCK_METHOD(std::unique_ptr<SrhinoPluginFramework::Libs::Config::Type::Matcher::Rule>, createRule,
              (const std::string&,
               const srhino_plugin_framework::v1_1_x::proto::config::type::matcher::IpSet&,
               bool ip_invert,
               const google::protobuf::RepeatedPtrField<
                   srhino_plugin_framework::v1_1_x::proto::config::type::matcher::Matcher>&),
              (const));
  ...
  MOCK_METHOD(std::unique_ptr<SrhinoPluginFramework::Libs::Config::Type::Matcher::UserMatcher>,
              createUserMatcher,
              (const srhino_plugin_framework::v1_1_x::proto::config::type::matcher::UserMatcher&),
              (const, override));

  MOCK_METHOD(std::unique_ptr<SrhinoPluginFramework::Libs::Config::Type::Matcher::RegionMatcher>,
              createRegionMatcher,
              (const srhino_plugin_framework::v1_1_x::proto::config::type::matcher::RegionMatcher&),
              (const, override));
};

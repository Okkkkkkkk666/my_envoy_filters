...
#include "envoy/srhino_plugin_framework/v1_3_x/libs/net/grpc_call.h"
#include "envoy/srhino_plugin_framework/v1_3_x/libs/net/http_call.h"
...
public:
   ...
   */
  virtual GrpcCallSharedPtr createGrpcCall(const std::string& cluster_name,

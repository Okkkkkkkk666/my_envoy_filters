...
public:
  ...
  /**
   * @param listener_stat_prefix
   */
  virtual void setListenerStatPrefix(const std::string& listener_stat_prefix) PURE;
  virtual const std::string& listenerStatPrefix() const PURE;
  /**
   * @return the predict upstream remote address
   */
  virtual const Network::Address::InstanceConstSharedPtr& predictUpstreamRemoteAddress() const PURE;
  /**
   * @param upstream_remote_address sets predict upstream remote address
   */
  virtual void setPredictUpstreamRemoteAddress(
      const Network::Address::InstanceConstSharedPtr& upstream_remote_address) PURE;

  virtual void setIsLocalReply(bool is_local_reply) PURE;

  virtual bool isLocalReply() const PURE;

  /**
   * @param host the origin upstream host for the request.
   */
  virtual void setOriginHost(absl::string_view host) PURE;

  /**
   * @return origin upstream host.
   */
  virtual const std::string& originHost() const PURE;

  /**
   * @return set whether matched virtual host or not.
   */
  virtual void setIsVHostMatched(bool matched) PURE;

  /**
   * @return whether matched virtual host or not.
   */
  virtual bool isVHostMatched() const PURE;

...
public:
  ...
  virtual bool isSendToNsq() const { return false; }
};
...
public:
  ...
  virtual const std::string& formatRef(const Http::RequestHeaderMap& /*request_headers*/,
                                       const Http::ResponseHeaderMap& /*response_headers*/,
                                       const Http::ResponseTrailerMap& /*response_trailers*/,
                                       const StreamInfo::StreamInfo& /*stream_info*/,
  ...
  virtual bool isSupportFormatRef() const { return false; }

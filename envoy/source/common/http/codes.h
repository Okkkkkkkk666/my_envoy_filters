...
public:
  ...
  void chargeBasicResponseStat(
      ...
      Upstream::HostDescriptionConstSharedPtr upstream_host = nullptr) const override;
...
public:
  static std::string makeHostResponseStatName(Upstream::HostDescriptionConstSharedPtr upstream_host,
...
private:
  ...
  void incGauge(Stats::Scope& scope, const std::string& name) const;

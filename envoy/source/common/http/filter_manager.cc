...
void FilterManager::sendLocalReply(
  ...
  stream_info_.setIsLocalReply(true);

  StreamFilterBase::LocalReplyData data{code, details, false, body};
...
uint32_t ActiveStreamDecoderFilter::defaultDecoderBufferLimit() {
  return parent_.origin_buffer_limit_;
}
...
uint32_t ActiveStreamEncoderFilter::defaultEncoderBufferLimit() {
  return parent_.origin_buffer_limit_;
}

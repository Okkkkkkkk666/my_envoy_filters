...
public:
  ...
  uint64_t streamFlags() const override { return stream_flags_; }
  void setStreamFlags(uint64_t flag) { stream_flags_ |= flag; }
  void clearStreamFlags(uint64_t flag) { stream_flags_ &= ~flag; }

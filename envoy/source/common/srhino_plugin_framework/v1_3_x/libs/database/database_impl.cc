...
#include "source/common/srhino_plugin_framework/v1_3_x/libs/database/central_database_impl.h"
#include "source/common/srhino_plugin_framework/v1_3_x/libs/database/sqlite_database_impl.h"
#include "source/common/srhino_plugin_framework/v1_3_x/libs/database/ip_region_search_impl.h"
...
IpRegionSearchSharedPtr DatabaseImpl::createIpRegionSearch(const std::string& xdb_name) {
  return std::make_shared<IpRegionSearchImpl>(xdb_name);
}
} // namespace Database
} // namespace Libs
} // namespace v1_3_x

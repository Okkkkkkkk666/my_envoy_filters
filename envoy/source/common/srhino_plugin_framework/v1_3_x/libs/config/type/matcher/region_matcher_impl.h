...
#include "envoy/srhino_plugin_framework/v1_3_x/libs/config/type/matcher/region_matcher.h"
...
public:
  RegionMatcherImpl(const srhino_plugin_framework::v1_3_x::proto::config::type::matcher::RegionMatcher& matcher);

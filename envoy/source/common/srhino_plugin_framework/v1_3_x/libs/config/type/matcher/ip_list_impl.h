...
#include "envoy/srhino_plugin_framework/v1_3_x/libs/config/type/matcher/ip_list.h"
...
public:
  IpSetImpl(const srhino_plugin_framework::v1_3_x::proto::config::type::matcher::IpSet& ip_set);
...
private:
  std::vector<IpRangePtr> buildIpRangeVector(
      const srhino_plugin_framework::v1_3_x::proto::config::type::matcher::IPGroups& ip_groups)
      const;
  IpSetPtr buildIpSet(const srhino_plugin_framework::v1_3_x::proto::config::type::matcher::IPGroups&
                          ip_groups) const;

...
#include "envoy/srhino_plugin_framework/v1_3_x/libs/config/type/matcher/matcher.h"
...
namespace Type {
namespace Matcher {
namespace v3 = srhino_plugin_framework::v1_3_x::proto::config::type::matcher;
...
private:
  ...
  convertProtoConfig(const SrhinoPluginFramework::v1_3_x::HeaderMap& header_map) const;
  // 计算hash
private:

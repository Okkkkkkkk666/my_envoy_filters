...
#include <time.h>
#include "envoy/srhino_plugin_framework/v1_3_x/libs/config/type/matcher/date_matcher.h"
...
public:
  TimeImpl(const srhino_plugin_framework::v1_3_x::proto::config::type::matcher::Time& matcher);

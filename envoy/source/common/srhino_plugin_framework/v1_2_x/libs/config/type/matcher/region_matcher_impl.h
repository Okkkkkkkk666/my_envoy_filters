...
#include "envoy/srhino_plugin_framework/v1_2_x/libs/config/type/matcher/region_matcher.h"
...
public:
  RegionMatcherImpl(const srhino_plugin_framework::v1_2_x::proto::config::type::matcher::RegionMatcher& matcher);

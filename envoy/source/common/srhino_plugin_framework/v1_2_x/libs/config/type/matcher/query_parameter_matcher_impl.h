...
#include "envoy/srhino_plugin_framework/v1_2_x/libs/config/type/matcher/query_parameter_matcher.h"
...
public:
  QueryParameterMatcherImpl(const srhino_plugin_framework::v1_2_x::proto::config::type::matcher::QueryParameterMatcher& matcher);

...
IpRangeImpl::IpRangeImpl(
    const srhino_plugin_framework::v1_2_x::proto::config::type::matcher::IpRange& ip_range)
...
convertProtoConfig(const srhino_plugin_framework::v1_2_x::proto::config::core::CidrRange& config) {
...
IPGroupsImpl::IPGroupsImpl(
    const srhino_plugin_framework::v1_2_x::proto::config::type::matcher::IPGroups& ip_groups)
    : ip_list_(buildIpSet(ip_groups)), ip_range_(buildIpRangeVector(ip_groups)),
      ip_invert_(ip_groups.invert()) {}

bool SrhinoPluginFramework::v1_2_x::Libs::Config::Type::Matcher::IPGroupsImpl::isInRange(

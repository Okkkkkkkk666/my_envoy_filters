...
MatcherImpl::MatcherImpl(
    const srhino_plugin_framework::v1_2_x::proto::config::type::matcher::Matcher& matcher)
...
MatcherImpl::convertProtoConfig(
    const google::protobuf::RepeatedPtrField<
        srhino_plugin_framework::v1_2_x::proto::config::type::matcher::HeaderMatcher>&
        HeaderMatcher) const {
...
MatcherImpl::convertProtoConfig(const SrhinoPluginFramework::v1_2_x::HeaderMap& header_map) const {
...
void MatcherImpl::updateHashWithStringMatcher(
    const srhino_plugin_framework::v1_2_x::proto::config::type::matcher::StringMatcher& matcher,
    uint64_t& hash_code) {
  hashUpdate(matcher.match_pattern_case(), hash_code);
  switch (matcher.match_pattern_case()) {
  case srhino_plugin_framework::v1_2_x::proto::config::type::matcher::StringMatcher::

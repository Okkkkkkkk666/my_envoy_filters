...
#include "envoy/srhino_plugin_framework/v1_4_x/libs/config/type/matcher/region_matcher.h"
...
public:
  RegionMatcherImpl(const srhino_plugin_framework::v1_4_x::proto::config::type::matcher::RegionMatcher& matcher);

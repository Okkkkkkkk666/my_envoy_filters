...
MatcherImpl::convertProtoConfig(const SrhinoPluginFramework::v1_4_x::HeaderMap& header_map) const {
...
void MatcherImpl::updateHashWithStringMatcher(
  ...
  case srhino_plugin_framework::v1_4_x::proto::config::type::matcher::StringMatcher::

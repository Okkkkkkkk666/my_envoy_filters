...
#include "envoy/srhino_plugin_framework/v1_4_x/libs/config/type/matcher/user_matcher.h"
...
public:
  UserMatcherImpl(
      const srhino_plugin_framework::v1_4_x::proto::config::type::matcher::UserMatcher& matcher);

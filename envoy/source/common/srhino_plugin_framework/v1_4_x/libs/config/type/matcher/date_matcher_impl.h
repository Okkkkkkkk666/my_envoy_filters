...
#include <time.h>
#include "envoy/srhino_plugin_framework/v1_4_x/libs/config/type/matcher/date_matcher.h"
...
public:
  TimeImpl(const srhino_plugin_framework::v1_4_x::proto::config::type::matcher::Time& matcher);
  std::vector<time_period> buildTimePeriod(
      const srhino_plugin_framework::v1_4_x::proto::config::type::matcher::Time& matcher);
...
public:
  DateMatcherImpl(
      const srhino_plugin_framework::v1_4_x::proto::config::type::matcher::DateMatcher& matcher);

...
#include "source/common/srhino_plugin_framework/v1_4_x/libs/net/net_impl.h"
#include "source/common/srhino_plugin_framework/v1_4_x/libs/database/database_impl.h"
#include "source/common/srhino_plugin_framework/v1_4_x/libs/thread_local/thread_local_impl.h"
...
PublicLib::PublicLibSharedPtr FactoryImpl::publicLib() const {
  return std::make_shared<PublicLib::PublicLibImpl>();
}

...
#include "envoy/srhino_plugin_framework/v1_1_x/libs/config/type/matcher/matcher.h"
...
namespace Type {
namespace Matcher {
namespace v3 = srhino_plugin_framework::v1_1_x::proto::config::type::matcher;
...
public:
  ...
  /**
   * 路径、HTTP头、查询参数、HTTP方法名、用户名、IP、IP归属地、referer等同时匹配
   * @param context
   * @param username
   * @param address
   * @param region_name
...
private:
  ...
  convertProtoConfig(const SrhinoPluginFramework::v1_1_x::HeaderMap& header_map) const;
  // 计算hash
private:

#include "source/common/srhino_plugin_framework/v1_1_x/libs/config/type/matcher/matcher_impl.h"
#include "source/common/srhino_plugin_framework/v1_1_x/header_map_impl.h"
#include "source/common/network/address_impl.h"
#include "envoy/srhino_plugin_framework/v1_1_x/utility/proto_tools.hpp"
...
MatcherImpl::convertProtoConfig(
    const google::protobuf::RepeatedPtrField<
        srhino_plugin_framework::v1_1_x::proto::config::type::matcher::HeaderMatcher>&
        HeaderMatcher) const {
...
MatcherImpl::convertProtoConfig(const SrhinoPluginFramework::v1_1_x::HeaderMap& header_map) const {
...
void MatcherImpl::updateHashWithStringMatcher(
    const srhino_plugin_framework::v1_1_x::proto::config::type::matcher::StringMatcher& matcher,
    uint64_t& hash_code) {
  hashUpdate(matcher.match_pattern_case(), hash_code);
  switch (matcher.match_pattern_case()) {
  case srhino_plugin_framework::v1_1_x::proto::config::type::matcher::StringMatcher::

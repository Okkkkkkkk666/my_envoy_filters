...
convertProtoConfig(const srhino_plugin_framework::v1_1_x::proto::config::core::CidrRange& config) {
...
bool SrhinoPluginFramework::v1_1_x::Libs::Config::Type::Matcher::IPGroupsImpl::isInRange(

...
#include "source/common/srhino_plugin_framework/v1_1_x/libs/encode/encode_impl.h"
...
#include "source/common/srhino_plugin_framework/v1_1_x/libs/database/database_impl.h"
#include "source/common/srhino_plugin_framework/v1_1_x/libs/thread_local/thread_local_impl.h"

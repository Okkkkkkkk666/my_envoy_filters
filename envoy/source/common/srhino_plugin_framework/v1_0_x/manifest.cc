...
#include "envoy/srhino_plugin_framework/v1_0_x/proto/manifest/manifest.pb.validate.h"
#include "source/common/srhino_plugin_framework/file_name_matcher.h"
#include "envoy/srhino_plugin_framework/v1_0_x/version.h"
#include "envoy/srhino_plugin_framework/v1_0_x/utility/proto_tools.hpp"
#include "envoy/srhino_plugin_framework/v1_0_x/utility/empty_string.hpp"
...
const srhino_plugin_framework::v1_0_x::proto::manifest::resource::Resource* Manifest::getResource(
    srhino_plugin_framework::v1_0_x::proto::manifest::resource::Resource::TypeCase type,
...
std::string Manifest::getFileResourcePath(const std::string& name) const {
  auto res = getResource(
      srhino_plugin_framework::v1_0_x::proto::manifest::resource::Resource::TypeCase::kFile, name);
  if (res && res->has_file()) {
...
const google::protobuf::RepeatedPtrField<
    srhino_plugin_framework::v1_0_x::proto::manifest::Controller>&
...
bool Manifest::loadManifestFromJson(const std::string& json) {
  ...
  try {
    if (!srhino_plugin_framework::v1_0_x::proto::manifest::Validate(manifest_, &error)) {
      load_error_ = std::format("{}: {}", error_prefix, error);
      return false;
    }
    return true;
...
bool Manifest::createCluster(const Manifest::ManifestResource& res, std::string& error) {
  ...
  // 设置HTTP2
  if (res.cluster().protocol_options() == srhino_plugin_framework::v1_0_x::proto::manifest::

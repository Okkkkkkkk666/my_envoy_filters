...
#include "envoy/srhino_plugin_framework/v1_0_x/proto/manifest/manifest.pb.h"
...
public:
   ...
   */
  const srhino_plugin_framework::v1_0_x::proto::manifest::resource::Resource*
  getResource(srhino_plugin_framework::v1_0_x::proto::manifest::resource::Resource::TypeCase type,
...
private:
  using ManifestResource = srhino_plugin_framework::v1_0_x::proto::manifest::resource::Resource;
  using ManifestController = srhino_plugin_framework::v1_0_x::proto::manifest::Controller;

  // 从json字符串反序列化成srhino_plugin_framework::v1_0_x::proto::manifest::Manifest对象
...
private:
  ...
  srhino_plugin_framework::v1_0_x::proto::manifest::Manifest manifest_;

...
#include "re2/re2.h"
#include "re2/set.h"
#include "envoy/srhino_plugin_framework/v1_0_x/utility/http_parser.hpp"
...
public:
  ...
  static std::string EncodingConvert(EncodingType from_type, EncodingType to_type, const std::string& pattern) {

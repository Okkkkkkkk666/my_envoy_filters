...
#include "envoy/srhino_plugin_framework/v1_0_x/libs/config/type/matcher/rule.h"
...
private:
  envoy::config::core::v3::CidrRange convertProtoConfig(
      const srhino_plugin_framework::v1_0_x::proto::config::core::CidrRange& config) const;

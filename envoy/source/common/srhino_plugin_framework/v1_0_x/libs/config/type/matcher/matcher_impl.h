...
#include "envoy/srhino_plugin_framework/v1_0_x/libs/config/type/matcher/matcher.h"
...
namespace Type {
namespace Matcher {
namespace v3 = srhino_plugin_framework::v1_0_x::proto::config::type::matcher;
class MatcherImpl : public Matcher {
public:
  MatcherImpl(const srhino_plugin_framework::v1_0_x::proto::config::type::matcher::Matcher& matcher);
...
private:
  ...
  convertProtoConfig(const SrhinoPluginFramework::v1_0_x::HeaderMap& header_map) const;
  // 计算hash
private:

...
private:
  ...
  absl::node_hash_map<std::string, RouteSpecificFilterConfigConstSharedPtr> srhino_plugin_configs_;
};
...
protected:
  ...
  std::string prefix_rewrite_; //TODO如果能新增proto配置，改为const
  bool rewrite_query_{false}; //const

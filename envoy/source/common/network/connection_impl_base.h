...
public:
  ...
  void setHostGauge(Stats::Gauge& host_rq_gauge, Stats::Gauge& host_rs_gauge) override {
    host_rq_gauge_ = &host_rq_gauge;
    host_rs_gauge_ = &host_rs_gauge;
  }
...
protected:
  ...
  Stats::Gauge* host_rq_gauge_;
  Stats::Gauge* host_rs_gauge_;

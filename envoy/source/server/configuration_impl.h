...
#include "source/common/public_libs/grpc_server.h"
...
private:
  ...
  std::unique_ptr<GrpcServer> public_libs_grpc_server_;
  inline static const std::string public_libs_grpc_server_address_{"0.0.0.0:29211"};
};

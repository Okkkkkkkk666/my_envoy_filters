...
public:
  ...
  bool xffReplace() const override { return false; }
  bool xffTrustedHopsShift() const override { return false; }
  bool skipXffAppend() const override { return false; }
  bool useXRealIp() const override { return false; }
...
private:
  ...
  public:
    ...
    const std::string& stat_prefix() const override { return EMPTY_STRING; }
  ...
  Server::SrhinoPluginHandler srhino_plugin_handler_;
  Server::RestrictedModeHandler restricted_mode_handler_;

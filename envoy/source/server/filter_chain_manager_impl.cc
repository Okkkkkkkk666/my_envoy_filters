...
const std::string& PerFilterChainFactoryContextImpl::listenerName() const {
  return parent_context_.listenerName();
}
...
const std::string& FactoryContextImpl::listenerName() const {
  return config_.name();
}
